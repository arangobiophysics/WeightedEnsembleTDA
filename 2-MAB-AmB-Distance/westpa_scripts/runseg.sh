...
ln -sfnv $WEST_SIM_ROOT/namd_config/1.psf structure.psf
ln -sfnv $WEST_SIM_ROOT/namd_config/1.pdb structure.pdb 
ln -sfnv $WEST_SIM_ROOT/namd_config/par .
